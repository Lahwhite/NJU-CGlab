...
## 更新记录
 ...
 - \[2025/09/01\] 9月提交地址已更新 https://box.nju.edu.cn/u/d/3429adfe271049c3a9e9/ 密码 cg2025b
...
1. 关于绘制时的纵坐标转换是什么意思？
    ...
    **请注意：Pillow库的早期版本以左下角为坐标原点，因此在cg_cli.py 37行提供的实例代码中通过行的运算变换了坐标原点。在编写实验代码时，请根据自己使用的库版本调整代码，以最终输出的视觉结果为主，坐标原点位于画布左上方**
...
- 提交方式：
    ...
    >
    > 9月提交地址：https://box.nju.edu.cn/u/d/3429adfe271049c3a9e9/
    > 
    > 9月提交期限：9月30日晚23:59，请勿错过提交期限
    >
    > 查看9月已提交的内容：https://box.nju.edu.cn/d/37fe53ffdf8c4817816c/
    >
    > 密码：cg2025b

    > 10月提交地址：
    > 
    > 10月提交期限：10月31日晚23:59，请勿错过提交期限
    >
    > 查看10月已提交的内容：
    >
    > 密码：cg2025b
...
--->绘制坐标与屏幕坐标统一，以左上为原点，x轴指向右，y轴指向下，根据输出结果自行调整; 
    ~~注意：旋转方向以新版本python相关库为基准，左上角为原点，例如绘制图形时某条输入“rotate polygon4 300 200 30”，旋转实则为顺时针，由于练习题是用旧版本出的，当时原点在左下角看起来为逆时针
- 不需要对椭圆进行旋转
...
**请注意：请在报告中注明Python，numpy，pillow，pyqt的适用版本**
